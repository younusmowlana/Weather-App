...
const MONGO_URI = 'mongodb+srv://younus:dCP1SUixMmQjaq13@cluster0.7fs8z.mongodb.net/';
...
const DISTRICTS = {
    ...
    "Kilinochchi": {"latitude": 9.3996, "longitude": 80.3990},
    ...
    "Moneragala": {"latitude": 6.8806, "longitude": 81.3490},
    ...
    "Ratnapura": {"latitude": 6.7050, "longitude": 80.3840},
...
async function insertWeatherData(district, latitude, longitude, temperature, humidity, airPressure) {
...
async function generateDemoData() {
    ...
    try {
        ...
        for (const [district, info] of Object.entries(DISTRICTS)) {
            ...
            const airPressure = `${Math.floor(Math.random() * (1020 - 1000 + 1)) + 1000} hPa`;
            await insertWeatherData(district, info.latitude, info.longitude, temperature, humidity, airPressure);
        }
        console.log("Data generation complete. Waiting for 5 minutes until the next update...");
